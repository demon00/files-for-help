<?php get_header(); ?>
      ...
      <div class="main-info__section">
          ...
          <div class="custom_select">
            ...
            <ul class="custom_options">
              <a href="index2.html" class="custom_li">ENG</a>
            </ul>
          </div>
    ...
    <div class="about-section">
  		...
  		<p class="about_main-par wow fadeInUp" data-wow-duration="0.7s" data-wow-delay="0.5s" data-wow-offset="200">Мне 25 лет, вёрсткой начал интерисоваться несколько лет назад.<br> За это время прошёл некоторые онлайн курсы:<br> 
  		...
  		<a class="about_link" href="http://www.it-academy.by/" title="it-academy" target="_blank">ПАРКА ВЫСОКИХ ТЕХНОЛОГИЙ</a> по программе &laquo;РАЗРАБОТКА ВЕБ-САЙТОВ С ИСПОЛЬЗОВАНИЕМ HTML, CSS И JAVASCRIPT&raquo;.<br> Я совершенствую свое мастерство день ото дня и получаю истинное удовольствие от результатов своей работы.</p>
 ...
 <h5 class="about__skills wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.9s" data-wow-offset="200">НАВЫКИ</h5>
   <div class="about__skill-wrapper">
        ...
        <p class="about__intentions wow fadeInUp" data-wow-duration="1s" data-wow-delay="3.7s" data-wow-offset="-400">
        	Я намерен упорно работать, хорошо разрабатывать, разрабатывать доступные и основанные на стандартах веб-сайтов с использованием современных методов.<br> Узнать что-то новое каждый день, и относиться к другим людям с большим уважением.</p>	
         </div> 
  			</section>
          ...
          <div class="works__wrapper">
           ...
           <div class="works__h2 wow fadeInDown" data-wow-duration="1s" data-wow-delay="1.5s" data-wow-offset="0">РАБОТЫ</div>
            ...
            <div class="work-project work-four">
              <a href="#" class="work_hover whov-fourth" title="Mail Seven Continent">
